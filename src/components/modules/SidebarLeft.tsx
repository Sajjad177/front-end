    ...
    <div className="flex flex-col gap-6">
        ...
        <div className="space-y-5">
          {suggestedPeople.map((person, index) => (
            <div key={index} className="flex items-center justify-between px-2">
              ...
              <Button
                variant="outline"
                className="text-gray-400 border-gray-200 text-xs h-8 px-3 hover:bg-[#007AFF] hover:text-white transition-all"
              >
                Connect
              </Button>
            </div>
      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
        <div className="flex justify-between items-center px-2">
          <h3 className="font-bold text-lg text-gray-800">Events</h3>
          <button className="text-[#007AFF] text-xs font-semibold hover:underline">
            See all
          </button>
        </div>
